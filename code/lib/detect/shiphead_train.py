# -*- coding: utf-8 -*-
"""
Created on Thu Jun 14 11:22:31 2018
...
class SolverWrapper(object):
    ...
    def __init__(self, solver_prototxt, roidb, index_record, pretrained_model=None):
        ...
        self.solver.net.layers[0].set_label(roidb, index_record)

    def snapshot(self):

        net = self.solver.net

        filename = (cfg.HEAD_SAVED_MODEL_NAME + '_iter_{:d}'.format(self.solver.iter) + '.caffemodel')
...
def train_net(solver_prototxt, roidb, index_record, pretrained_model=None, max_iters=10000):
